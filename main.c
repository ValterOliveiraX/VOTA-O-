...
| SISTEMAS DE INFORMAÇÃO - ALGORITMOS E ESTRUTUTURAS DE DADOS I   |
...
entra_nomeCand(char *nomeCand) {
  printf("\nDigite o nome do candidato? ");
  fflush(stdin);
  scanf("%s", nomeCand);
}

entra_numCand(int *numCand) {
  printf("\nDigite o numero do candidato? ");
  fflush(stdin);
  scanf("%d", numCand);
}

entra_partido(char *partido) {
  printf("\nDigite o partido do candidato? ");
  fflush(stdin);
  scanf("%s", partido);
}

entra_cargo(char *cargo) {
  printf("\nDigite o cargo do candidato? ");
  fflush(stdin);
  scanf("%s", cargo);
}

entra_qtdVotos(int *qtd_votos) {
